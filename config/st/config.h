 ...
 */
static char *font = "JetBrainsMono Nerd Font Propo:pixelsize=24:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
static Shortcut shortcuts[] = {
    ...
    /* Zoom – plain Ctrl works, and keep the old Ctrl+Shift ones too */
    { ControlMask,          XK_equal,   zoom,       {.f = +1} },
    { ControlMask,          XK_minus,   zoom,       {.f = -1} },
    { ControlMask,          XK_0,       zoomreset,  {.f = 0}  },

    { TERMMOD,              XK_equal,   zoom,       {.f = +1} },  /* Ctrl+Shift+=  */
    { TERMMOD,              XK_minus,   zoom,       {.f = -1} },  /* Ctrl+Shift+-  */
